...
<template>
  <div class="min-h-screen bg-neutral-50 text-neutral-900 flex flex-col font-sans">
    ...
    <header class="border-b border-neutral-200/80 bg-white sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        <div class="flex items-center space-x-3">
          <div class="w-8 h-8 rounded-lg bg-black flex items-center justify-center overflow-hidden shadow-xs border border-neutral-800 shrink-0">
            <img :src="logoUrl" alt="GameCurveProbe Logo" class="w-full h-full object-contain p-0.5" />
          </div>
          <div>
            <div class="flex items-center space-x-2">
              ...
              <a
                href="https://github.com/HK560/GameCurveProbe"
                target="_blank"
                rel="noopener noreferrer"
                title="GitHub: HK560/GameCurveProbe"
                class="inline-flex items-center justify-center p-1 rounded-md text-neutral-400 hover:text-neutral-900 hover:bg-neutral-100 transition-colors"
              >
              ...
              <a
                href="https://qm.qq.com/q/PSfZ4nbEUW"
                target="_blank"
                rel="noopener noreferrer"
                :title="t('qq_group')"
                class="inline-flex items-center justify-center p-1 rounded-md text-neutral-400 hover:text-sky-500 hover:bg-neutral-100 transition-colors"
              >
    ...
    <footer class="sticky bottom-0 z-40 bg-white/95 backdrop-blur-md border-t border-neutral-200 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] py-4 px-6">
      <div class="max-w-7xl mx-auto flex items-center justify-center gap-4 sm:gap-6">
        ...
        <button
          ...
          @click="navigatePrev"
          :disabled="!canGoPrev"
          class="min-w-[180px] sm:min-w-[200px] h-12 inline-flex items-center justify-center gap-2.5 px-6 rounded-xl border border-neutral-300 bg-white hover:bg-neutral-50 active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100 text-sm font-medium text-neutral-700 hover:text-neutral-900 transition-all cursor-pointer shadow-xs"
        >
          <ArrowLeft class="w-5 h-5 text-neutral-500" />
          <span>
            {{
        ...
        <button
          ...
          :disabled="!canGoNext"
          :title="nextTooltip"
          class="min-w-[220px] sm:min-w-[260px] h-12 inline-flex items-center justify-center gap-2.5 px-7 rounded-xl bg-neutral-900 hover:bg-neutral-800 active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100 text-sm sm:text-base font-semibold text-white transition-all cursor-pointer shadow-md hover:shadow-lg disabled:hover:shadow-md"
        >
          <span>
            {{
          ...
          <RotateCcw v-if="sessionStore.activeStep === 4" class="w-5 h-5" />
