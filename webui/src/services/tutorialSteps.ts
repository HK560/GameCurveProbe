...
const catalog: StepCopy[] = [
  ...
  { id: 'export', chapter: 6, page: 4, target: 'analysis-export', zh: ['导出与导入报告', 'JSON 保留完整结构，CSV 适合表格分析；历史 JSON 可导入对照。教程不会打开或下载文件。'], en: ['Export & Import Reports', 'JSON retains the complete data structure; CSV is suitable for spreadsheet analysis; historical JSON files can be imported for comparison. The tutorial does not open or download files.'] },
